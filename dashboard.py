                ...
                with col_links:
                    if _data:
                        try:
                            ...
                            pass
                    _fonte_label = {"mega": "Mega Leilões", "pacto": "Pacto", "leilo": "Leilo", "mgl": "MGL Leilões", "montenegro": "Montenegro Leilões", "construbem": "Construbem", "danielgarcia": "Daniel Garcia", "mj": "MJ Leilões", "celsocunha": "Celso Cunha", "receita_sle": "Receita Federal", "francisco_freitas": "Francisco Freitas Leilões", "grupo_lance": "Grupo Lance"}.get(lote.get("fonte",""), "Leilão")
